...
import { colorbg } from "../../DataBase";
  ...
  export default function CertificatePaySCreen({ navigation }) {
    ...
    const SaveDataToFirestore = async () => {
      ...
      const userRef = doc(db, "Certificate_Paid", fullName);
      ...
      Alert.alert("Data Successfully Store in Firebase/Firestore ok");
