...
export default function Payment({ navigation}) {
  ...
  const saveDataToFirebase = async () => {
    ...
    const imageRef = ref(storage, 'Recipt_images/' +Date.now() );
    ...
    const userRef = doc(db, 'Paid_User', fullName);
    ...
    Alert.alert('Uploaded a Recept to database!')
...
<ScrollView>
      ...
      <View style={styles.card__container}>
        ...
        <Image
          ...
          source={{uri:"https://banner2.cleanpng.com/20180327/zdw/kisspng-television-jazz-download-android-cash-5ab9f04459d645.926325111522135108368.jpg"}}></Image>

        {/* MasterCard */}
        <Image
          style={{ width: 50, height: 40, marginHorizontal: 9 }}
          source={{uri:"https://banner2.cleanpng.com/20180824/rho/kisspng-telenor-pakistan-mobile-phones-bank-telenor-sales-easypaisa-empowers-dairy-farmers-with-smart-milk-p-5b8001c128ec82.9655885215351157131676.jpg"}}
        ></Image>

        {/* Visa Card */}
        <Image
          style={{ width: 50, height: 40 }}
          source={{uri:"https://w7.pngwing.com/pngs/305/373/png-transparent-logo-mastercard-font-solar-home-text-orange-logo.png"}}
        ></Image>
      </View>
      {/* Horizontal Row */}
      ...
      <View style={{backgroundColor:colorbg.bgdarkpro, justifyContent:"center", alignItems:"center", borderRadius:10}}>
        <Text style={{color:"#fff", marginBottom: 6, fontWeight: "700", fontSize:17 }}>Course amount</Text>
        </View>
        ...
        <TextInput
         aria-disabled={true}
          ...
          value={txId}
        ></TextInput>
 <TouchableOpacity style={styles.getBtn} onPress={handletxid}>
        ...
        <TouchableOpacity onPress={pickImage} style={[styles.UpBtn,{flexDirection:"row", justifyContent:"center"}]}>
        <Entypo name="upload" size={25} color="#fff" style={{paddingRight:"3%"}}/>
